...
public:
	...
	friend std::pair<std::string, std::string> viterbi2(const std::string& x, const std::string& y,HMM& h); // Viterbi algoritam za pairwise sequence alignment
...
private:
	...
	std::vector<std::string> symbols;  //simboli - emitirani parovi 
	...
	std::vector<double> pi; // MATRICA POČETNIH VJEROJATNOSTI, pi[i] je vjerojatnost da je model u stanju i u trenutku 0
